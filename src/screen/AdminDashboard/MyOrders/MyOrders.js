...
import {USER_DATA, ORDER_DATAFILTER} from '../../../redux/reducer/AdminReducer'
...
const RegisterClient = () => {
    ...
    const Customer = useSelector(USER_DATA)
            ...
            <div className="myOrder-tableSort">
                ...
                <CssFormControl variant="outlined">
                    ...
                    >
                        ...
                        {Customer.results.map((v,i) => <MenuItem value={v.id}>{v.username}</MenuItem>)}
